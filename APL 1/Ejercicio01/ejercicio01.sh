...
if test $2 == "L" then
res=`wc -l $1`
echo "Cantidad de lineas de $1: $res" # COMPLETAR
elif test $2 == "C"; then
res=`wc -m $1`
echo "Cantidad de caracteres de : $res" # COMPLETAR
elif test $2 =="M"; then
res=`wc -L $1`
...
ErrorS
 ...
 # los parametros son mas 2 o mas se verifica terner permisos de lectura sobre el archivo pasado por
 ...
 #
 #5) $# es una variable que nos brinda la cantidad (contando desde el 0) de parametros que recibio 
 # el script.Conocemos $@ y $* que nos lista todos los parametros recibido y $? que nos da el
