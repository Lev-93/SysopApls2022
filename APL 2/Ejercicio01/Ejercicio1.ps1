...
#2) Se podria agrgar una validacion para asegurar que el parametro segundo parametro es la cantidad de proceso a mostrar en pantalla y 
...
#   de que no exista un archvio \procesos.txt se
